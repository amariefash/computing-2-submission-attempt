...
Notice on AI:
AI tools were used in the creation of this project. This project made use of Claude (Anthropic) during development. All game logic was produced by myself, but AI tools were used for debugging issues, fixing errors, and learning optimal ways of structuring some functions. All game logic, comments, and code has been reviewed and written/edited by me!